...
.factory('StudRab', function() {
  ...
  var studrab = [
    ...
    { id: 3, name: 'Toten treningssenter', adr: "Storgata 25, 2815 Gjøvik", txt: "Basismedlemskapet 519,- pr mnd. Alle betaler en klubbkontingent ved oppstart, den er på 990,-. Ønsker studentene å velge medlemskap på Otium Spa, uten tilgang til Toten Treningssenter koster dette 519,- pr mnd. Velges det i medlemskapet og kunne benytte begge steder kommer et tillegg på 150,-", logo: "img/toten.png", kat: "trening" },
      ...
      { id: 10, name: 'Urban Style', adr: "Storgata 3, 2815 Gjøvik", txt: "10 % rabatt på all behandling", logo: "img/urban.jpg", kat: "helse" },
      { id: 11, name: 'b.young', adr: "Storgata 3, 2815 Gjøvik", txt: "20 % rabatt på hele kjøpet", logo: "img/byoung-logo.jpg", kat: "klaer" },
      { id: 12, name: 'G-Sport', adr: "Storgata 3, 2815 Gjøvik", txt: "15 % på alle ordinære varer. (Ikke allerede nedsatte varer eller tilbud) 10 % på alle sykler", logo: "img/gsport.jpg", kat: "klaer" },
      ...
      { id: 14, name: 'Gjøvik Kino og Kulturhus', adr: "Elvegata 6, 2815 Gjøvik", txt: "10,- i rabatt per kinobillett.", logo: "img/gjovikkino.png", kat: "kultur" },
      { id: 15, name: 'Oddproductions', adr: "Friscena, Gjøvik kulturhus", txt: "100,- per billett (ordpris 150,-)", logo: "img/oddprod.jpg", kat: "kultur" },
      { id: 16, name: 'Elvedalen Gokartutleie', adr: "Snertingdalsvegen 1294, 2838 Snertingdal", txt: "110,- per person for 10 minutter (ordpris 130,-)", logo: "", kat: "kultur" },
      { id: 17, name: 'Gjøvik og Toten Golfklubb', adr: "Sillongenvegen 147, 2846 Bøverbru", txt: "100.- pr.dag/pr. greenfee. 50% på medlemskap – 750,-", logo: "img/golf.jpg", kat: "kultur" },
      { id: 18, name: 'Telenorbutikken Gjøvik', adr: "Jernbanesvingen 6 2821 Gjøvik", txt: "20 % rabatt på tilbehør til mobiltelefoner", logo: "img/telenor.jpg", kat: "elektronikk" },
      { id: 19, name: 'Gjøvik Vandrerhjem', adr: "Parkvegen 8, 2819 Gjøvik", txt: "Enkelt rom med bad 625,- Enkelt rom med vask 450,- (ordpris 595,-) To sengs rom med bad 800,-  Firesengs rom med bad 1300,- Selvsmurt matpakke 30,- (ordpris 69,-) (OBS! Gjelder kun ved telefonbestilling)", logo: "", kat: "annet" },
      { id: 20, name: 'Interoptik Gjøvik', adr: "Storgata 5, 2815 Gjøvik", txt: "15 % på glass og innfatning ved kjøp av komplette briller. 15 % på solbriller.", logo: "img/interoptik.jpg", kat: "annet" },
      { id: 21, name: 'Notabene', adr: "Jernbanesvingen 6, 2821 Gjøvik", txt: "15 % rabatt på rekvisita", logo: "img/notabene.jpg", kat: "annet" },
      { id: 22, name: 'Synsam', adr: "Jernbanesvingen 6, 2821 Gjøvik", txt: "Mulighet for brillekonto for studenter, hvor man kan dele opp betalingen i 6, 12 eller 24 mnd rentefritt.", logo: "img/synsam.jpg", kat: "annet" }
  ];
